...
// SlackSpec defines the desired state of Slack
type SlackSpec struct {
	// INSERT ADDITIONAL SPEC FIELDS - desired state of cluster
	// Important: Run "make" to regenerate code after modifying this file

	// Foo is an example field of Slack. Edit Slack_types.go to remove/update
	URL  string `json:"url"`
	Size int32  `json:"size"`
}

// SlackStatus defines the observed state of Slack
...
// Slack is the Schema for the slacks API
type Slack struct {
